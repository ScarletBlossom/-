...
template <> constexpr inline auto httpmgr::qt_create_metaobjectdata<qt_meta_tag_ZN7httpmgrE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Signal 'sig_changepw_mod_finish'
...
void httpmgr::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->sig_changepw_mod_finish((*reinterpret_cast< std::add_pointer_t<ReqId>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<ErrorCodes>>(_a[3]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (httpmgr::*)(ReqId , QString , ErrorCodes )>(_a, &httpmgr::sig_reg_mod_finish, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (httpmgr::*)(ReqId , QString , ErrorCodes )>(_a, &httpmgr::sig_changepw_mod_finish, 2))
            return;
...
// SIGNAL 2
void httpmgr::sig_changepw_mod_finish(ReqId _t1, QString _t2, ErrorCodes _t3)
{
